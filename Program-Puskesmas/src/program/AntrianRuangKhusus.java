...
public class AntrianRuangKhusus extends Antrian{
    ...
    public AntrianRuangKhusus(String nomorAntrian, Pasien pasien, Dokter dokter) {
        this.nomorAntrian = nomorAntrian;
        this.pasien = pasien;
        this.IDDokter = IDDokter;
    }
    
    public AntrianRuangKhusus(String nomorAntrian) {
        this.nomorAntrian = nomorAntrian;
    ...
    public String getIdPasienDatabase(String nomorAntrian){
        ...
        try {
            openDB();
            rs = s.executeQuery("SELECT IDPasien FROM AntrianRuangKhusus WHERE IDPasien = '" + nomorAntrian + "';");
            rs.next();
    ...
    public void inputDatabaseAntrian(String nomorAntrian, Pasien pasien, Dokter dokter){
        try {
            ...
            s.executeUpdate(
                "INSERT INTO AntrianRuangKhusus VALUES ('" + nomorAntrian + "','" + IDPasien + "','" + IDDokter + "')"
            );
        }catch (SQLException | ClassNotFoundException ex){
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, ex.getLocalizedMessage());
    ...
    public void updateDatabaseAntrian(String nomorAntrian, Pasien pasien, Dokter dokter){
        try {
            ...
            String IDDokter = dokter.getIdDokter();
            s.executeUpdate(
                "UPDATE AntrianRuangKhusus SET IDPasien = '" + IDPasien + "', IDDokter = '" + IDDokter + "' WHERE nomorAntrian = '" + nomorAntrian + "';"
            );
        }catch (SQLException | ClassNotFoundException ex){
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, ex.getLocalizedMessage());
    ...
    public void deleteDatabaseAntrian(String nomorAntrian){
        try {
            openDB();
            s.executeUpdate(
                "DELETE FROM AntrianRuangKhusus WHERE nomorAntrian = '" + nomorAntrian + "';"
            );
        }catch (SQLException | ClassNotFoundException ex){
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, ex.getLocalizedMessage());
